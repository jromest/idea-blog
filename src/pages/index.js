      ...
      <main role="main">
        ...
        <section className="container container-main section">
          ...
          <p>
            ...
            and develop experiences that make people's lives simple. I
            specialize in <strong>JavaScript</strong> and <strong>React</strong>{' '}
            'n' friends that I learned mostly self-taught and growing my skills
            and learning new things every day.
          </p>
          <p>
            Outside of work, I am probably running, trekking or hiking.
            Otherwise, probably watch movies or reading books.
          </p>
        </section>
        ...
        <section
          id="projectSection"
          className="container container-main section"
        >
          ...
          <article>
            ...
            <p>
              ...
              implemented under <code>learn.freecodecamp.org</code> sub-domain.
            </p>
            <a
              className="section-project-link"
